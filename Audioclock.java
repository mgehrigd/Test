...
public class Audioclock {
    ...
    private static void playAudioFile(String file) {
        try {
            File yourFile = new File("audio/" +file); //Add audio/ folder to root and insert wav files
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> result = new ArrayList<>(); // Saves audio files and plays them all at the end.
        result.add("its.wav");
        String timeDay = "";
